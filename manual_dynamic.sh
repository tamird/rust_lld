...
$LLVM/lld -demangle -dynamic -arch x86_64 -o target/hello_world -L$RUSTLIB target/hello_world.o -force_load $RUSTLIB/libmorestack.a -dead_strip -lstd-4e7c5e5c -lSystem -lpthread -lc -lm -rpath @loader_path/../../rust-build/x86_64-apple-darwin/stage2/lib/rustlib/x86_64-apple-darwin/lib -rpath /usr/local/lib/rustlib/x86_64-apple-darwin/lib -flavor darwin -lcompiler-rt ||
echo '`lld` segfaulted, trying without `-lpthread -lc -lm`' &&
# removing `-lpthread -lc -lm` fixes the segfault 100% of the time!
$LLVM/lld -demangle -dynamic -arch x86_64 -o target/hello_world -L$RUSTLIB target/hello_world.o -force_load $RUSTLIB/libmorestack.a -dead_strip -lstd-4e7c5e5c -lSystem -rpath @loader_path/../../rust-build/x86_64-apple-darwin/stage2/lib/rustlib/x86_64-apple-darwin/lib -rpath /usr/local/lib/rustlib/x86_64-apple-darwin/lib -flavor darwin -lcompiler-rt
