...
$LLVM/lld -flavor darwin -demangle -dynamic -arch x86_64 -o target/$FILE -L$RUSTLIB target/$oFile -force_load $RUSTLIB/libmorestack.a -dead_strip -l$STD -lSystem -lpthread -lc -lm -rpath @loader_path/../../rust-build/x86_64-apple-darwin/stage2/lib/rustlib/x86_64-apple-darwin/lib -rpath /usr/local/lib/rustlib/x86_64-apple-darwin/lib -lcompiler-rt
